        ...
        <View style={styles.containerStyle}>
          ...
          <View style={{ flexDirection: "row", padding: calcWidth(2) }}>
            ...
            >
              ...
              <Text style={styles.number}>{item.number_first}</Text>
            </View>
          </View>
          {/* finish first row */}
          ...
          <View style={{ flexDirection: "row", padding: calcWidth(2) }}>
            ...
            >
              <Text style={styles.title}>{item.title_second}</Text>
              <Text style={styles.number}>{item.number_second}</Text>
            </View>
          </View>
          {/* finish first row */}
        </View>
